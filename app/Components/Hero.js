...
const Hero = () => {
  return (
    <>
    <div className="z-10 flex flex-col items-center md:items-start gap-y-4 mt-10 mb-auto left-1/2 top-1/2 transform ">
      ...
      <header >
        <div className="flex flex-col items-center md:items-start gap-y-4">
          ...
          <h2 className="text-white/70 text-md sm:text-lg md:text-xl text-center md:text-left max-w-lg ">
